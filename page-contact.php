        ...
        <div class="row">
          <div class="col-lg-7 col-sm-12">
            ...
            <form class="contact__form" method="post" action="<?php echo admin_url('admin-ajax.php'); ?>">
              ...
              <!-- Добавляем скрытое поле action, в которое передаются все данные при помощи contact.js -->
          ...
          <div class="col-lg-5 pl-4 mt-4 mt-lg-0">
            <h4>Адрес офиса</h4>
            <p class="mb-3"><?php the_field('address', $post->ID); ?></p>
            <h4>Телефон</h4>
            <p class="mb-3"><?php the_field('phone', $post->ID); ?></p>
            <h4>E-Mail</h4>
            <p class="mb-3"><?php the_field('e-mail', $post->ID); ?></p>
          </div>
        </div>
      </div>
    </section>
