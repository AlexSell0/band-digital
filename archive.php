            ...
            <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
                <div class="banner-content content-padding">
                    <h1 class="text-white"><?php
                        if (is_category()){
                            single_cat_title( '<small>Рубрика</small><br>' );
                        }else if( is_tag() ){
                            single_cat_title( '<small>Метка</small><br>' );
                            // the_archive_title('<small>Метка</small><br>' ,'');
                        }else if( is_author() ){
                            echo '<small>Посты автора</small><br>' . get_the_author_meta( 'display_name' );
                        }else if ( is_date() ){
