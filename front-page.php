...
<!--MAIN BANNER AREA START -->
            ...
            <div class="row">
              <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
                <div class="banner-content content-padding">
                  ...
                  <p><?php echo get_post_meta($post->ID, 'banner-description', true); ?></p>
    ...
    <!--  Подключаем сервисы  -->
     <?php get_template_part( 'template-parts/content', 'service', ['class' => 'bg-feature', 'header'  => 'Диджитал полного цикла', 'description' => 'Это означает, что мы сможем выполнить любую цифровую задачу:<br>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-sm-6 col-md-6">
            <div class="counter-stat">
              ...
              <span class="counter"><?php the_field('complite-project', $post->ID); ?></span>
          ...
          <div class="col-lg-3 col-sm-6 col-md-6">
            <div class="counter-stat">
              ...
              <span class="counter"><?php the_field('people', $post->ID); ?></span>
          ...
          <div class="col-lg-3 col-sm-6 col-md-6">
            <div class="counter-stat">
              ...
              <span class="counter"><?php the_field('project', $post->ID); ?></span>
